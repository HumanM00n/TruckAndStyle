...
export async function registerUser(formData: FormData) {
    ...
    const user_type = 2; // Type d'utilisateur (ex: normal)

    // Vérification des champs obligatoires
    if (!user_lastname || !user_firstname || !user_email || !user_password || !user_phone_number || !user_department || !user_postcode || !user_city) {
