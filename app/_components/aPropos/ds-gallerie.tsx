    ...
    return (
        <section className="w-auto min-h-[80vh] bg--grisArdoise text-white px-2 py-4">
            <div className="flex justify-center md:justify-start">
                <h2 className={clsx(playfair.variable, "text-3xl mt-3 mb-4 font-semibold pl-5 lg:pl-10")}>La <span className="color--form">Gallerie</span></h2>
                {/* <h2 className={"text-3xl mt-3 mb-4 pl-5 lg:pl-10"}>La <span className="color--form">Gallerie</span></h2> */}
            </div>
