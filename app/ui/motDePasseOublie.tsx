        ...
        <section className="h-full w-auto">
            <form onSubmit={handleUpdate} className="flex flex-column justify-center gap-5 pl-5 md:items-center md:pl-0">
                ...
                <div className="flex justify-center">
                    ...
                    {responseMessage && (
                        <div className={`mt-4 p-3 rounded-md text-sm absolute right-3 top-0 ${responseMessage.includes("enregistré")
                                    ? "bg-green-100 text-green-800"
                                    : "bg--bleuGris text-white" }`}>
                            {responseMessage}
                            {responseMessage.includes("enregistré") && (
